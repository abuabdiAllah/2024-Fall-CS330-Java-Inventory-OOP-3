...
public class Armour extends Equippable {
    ...
    public boolean equals(Object rhs)
    {
        ...
        if((this.getName()==rhsItem.getName()) && (this.getMaterial()==rhsItem.getMaterial()) && 
        (this.getModifier()==rhsItem.getModifier()) && (this.getModifierLevel()==rhsItem.getModifierLevel()) 
        && (this.getElement()==rhsItem.getElement()) && (this.getDefense()==rhsItem.getDefense()))
        {
            return true;
        }
        else
